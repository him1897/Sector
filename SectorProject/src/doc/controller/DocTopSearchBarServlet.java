...
/**
 * Servlet implementation class DocTopSearchBarServlet
 */
@WebServlet("/dtsbs")
public class DocTopSearchBarServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DocTopSearchBarServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Doc> list = dservice.docTopSearchBar(docName);
