...
<body>
    ...
    <div class="row" style="width: 100%; height: 100%;">
        ...
        <nav id="side-menu">
            <div id="sidemenu">
                ...
                <div id="genre" style="width: 100%; margin-top: 10%;">
    ...
    <div id="enter">
<table class="table table-hover" style="width: 25%; text-align: center; margin-top: 15px;" >
  <thead>
    <tr>
		<% if(post.getEmpId() == loginMember.getEmpId()) { %>    
    
      <th scope="col"><a href="/sector/upvs?postid=<%= post.getPostId() %>">수정</a></th>
      <th scope="col"><a href="/sector/dps?postid=<%= post.getPostId() %>">삭제</a></th>
  ...
  <div class="card-header">
      <p><h3> <%= post.getPostTitle() %>  </h3></p>      
      <p><h4> <%= post.getWriter() %> </h4></p>
  </div>
  <div class="card-body">
